...
export function ServerManageForm({ server }: { server: { id: string; slug: string; name: string; description: string | null; websiteUrl: string | null; storeUrl: string | null; discordUrl: string | null; tags: Array<{ label: string; slug: string }>; publicationStatus: "draft" | "published" | "hidden"; endpoints: Endpoint[]; role: "owner" | "admin" | "editor" } }) {
