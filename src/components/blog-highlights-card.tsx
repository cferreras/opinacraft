  ...
  return (
    <Card className={`gap-0 py-0 ${className}`}>
      <div className="flex items-center justify-between gap-2 px-4 py-3 lg:h-10 lg:py-0">
        <h2 id="blog-highlights-heading" className="text-sm font-semibold tracking-tight lg:text-[0.8125rem] lg:font-extrabold">Del blog</h2>
      ...
      >
        <Image src={featured.cover} alt={featured.coverAlt} width={480} height={297} sizes="(min-width: 1024px) 15rem, 100vw" className="aspect-[1.618/1] h-auto max-h-[13.75rem] w-full object-cover lg:max-h-none" />
