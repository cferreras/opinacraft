...
export function ServerForm() {
  ...
  const draft: ServerDraft = { name, gameModes, country, host, javaEnabled, javaPort, bedrockEnabled, bedrockPort, logoName: logoFile?.name ?? null };
